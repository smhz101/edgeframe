...
add_action(
	'edgeframe_header_nav',
	function () use ( $menu_align ) {
		wp_nav_menu(
			array(
				'theme_location' => 'primary',
				'container'      => false,
				'menu_class'     => 'menu align-' . esc_attr( $menu_align ),
			)
		);
	}
);
...
add_action(
	'edgeframe_header_cta',
	function () use ( $show_cta, $cta ) {
		if ( ! $show_cta ) {
			return; }
